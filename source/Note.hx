...
class Note extends FlxSprite
{
	...
	public var playerOnOpponentNote:Bool = false;
	public var opponentOnPlayerNote:Bool = false;
	public var playerAndGFOnOpponentNote:Bool = false;
	public var opponentAndGFOnPlayerNote:Bool = false;
	...
	private function set_noteType(value:String):String
	{
		...
		if (noteData > -1 && noteType != value)
		{
			switch (value)
			{
				...
				case 'GF Duet':
					duetNote = true;
				case 'Player On Opponent Side':
					playerOnOpponentNote = true;
				case 'Opponent On Player Side':
					opponentOnPlayerNote = true;
				case 'Player And GF On Opponent Side':
					playerAndGFOnOpponentNote = true;
				case 'Opponent And GF On Player Side':
					opponentAndGFOnPlayerNote = true;
			}
			noteType = value;
		}
