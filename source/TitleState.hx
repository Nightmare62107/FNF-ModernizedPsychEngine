...
class TitleState extends MusicBeatState
{
	...
	var easterEggKeys:Array<String> = ['SHADOW', 'RIVER', 'SHUBS', 'BBPANZU', 'PSYKA'];
	...
	function startIntro()
	{
		if (!initialized)
		{
			...
			FlxTransitionableState.defaultTransIn = new TransitionData(FADE, FlxColor.BLACK, 1, new FlxPoint(0, -1), {asset: diamond, width: 32, height: 32}, new FlxRect(-300, -300, FlxG.width * 1.8, FlxG.height * 1.8));
			FlxTransitionableState.defaultTransOut = new TransitionData(FADE, FlxColor.BLACK, 0.7, new FlxPoint(0, 1), {asset: diamond, width: 32, height: 32}, new FlxRect(-300, -300, FlxG.width * 1.8, FlxG.height * 1.8));
		...
		switch(easterEgg.toUpperCase())
		{
			...
			case 'PSYKA':
				gfDance.frames = Paths.getSparrowAtlas('PsykaBump');
