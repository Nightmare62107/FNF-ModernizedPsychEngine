...
class Achievements
{
	...
	[
		...
		["That's How You Do It!",			"Beat the Tutorial Week on Hard with no Misses.",	'tutorial_nomiss',		false],
		...
		["Blueballer",						"Get Blueballed over 100 times.",					'blueballer',			false],
		["Rhythm Gamer",					"Hit Notes over 10000 times.",						'rhythm_gamer',			false],
		["Rhythm Failure",					"Miss Notes over 5000 times.",						'rhythm_failure',		false],
		["Oversinging Much...?",			"Hold down a note for 10 seconds.",					'oversinging',			false],
		["Hyperactive",						"Finish a Song without going Idle.",				'hype',					false],
		["Just the Two of Us",				"Finish a Song pressing only two keys.",			'two_keys',				false],
		["Pause Screen RNG",				"See the Gitaroo Pause Screen.",					'gitaroo_pause',		 true],
	...
	public static var totalNotesMissed:Int = 0;
	public static var gitarooPauses:Int = 0;
